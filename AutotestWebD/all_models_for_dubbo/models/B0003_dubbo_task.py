...
class Tb2DubboTask(models.Model):
    ...
    protocol = models.CharField(max_length=20,verbose_name="任务协议",default="DUBBO")
    ...
    addBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="Tb2DubboTaskAddBy", on_delete=models.CASCADE, db_column='addBy', verbose_name="创建者登录名")
...
class Tb2DubboTaskExecute(models.Model):
    ...
    execBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="Tb2DubboTaskExecuteExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名", on_delete=models.CASCADE)
    ...
    state = models.IntegerField(default=1, verbose_name="状态 0删除 1有效")
    addBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="Tb2DubboTaskExecuteAddBy", on_delete=models.CASCADE, db_column='addBy', verbose_name="创建者登录名")
    modBy = models.CharField(max_length=25,db_column='modBy',null = True, verbose_name="修改者登录名")
    addTime = models.DateTimeField(db_column='addTime',auto_now_add=True, verbose_name="创建时间")
    modTime = models.DateTimeField(db_column='modTime',auto_now=True, verbose_name="修改时间")
...
class Tb2DubboInterfaceExecuteHistory(models.Model):
    ...
    taskExecuteId = models.ForeignKey(to=Tb2DubboTaskExecute,related_name="Tb2DubboInterfaceExecuteHistoryTaskExecuteId",db_column='taskExecuteId', verbose_name="任务执行表的主键ID，关联哪次执行的任务", on_delete=models.CASCADE)
    ...
    execBy = models.ForeignKey(to=TbUser,to_field="loginName",related_name="Tb2DubboInterfaceExecuteHistoryExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名", on_delete=models.CASCADE)
    testReportUrl = models.CharField(db_column='testReportUrl', max_length=200, verbose_name="报告路径")

    state = models.IntegerField(default=1, verbose_name="状态 0删除 1有效")
    addBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="Tb2DubboInterfaceExecuteHistoryAddBy", on_delete=models.CASCADE, db_column='addBy', verbose_name="创建者登录名")
    modBy = models.CharField(max_length=25,db_column='modBy',null = True, verbose_name="修改者登录名")
    addTime = models.DateTimeField(db_column='addTime',auto_now_add=True, verbose_name="创建时间")
    modTime = models.DateTimeField(db_column='modTime',auto_now=True, verbose_name="修改时间")
...
class Tb2DubboBatchTask(models.Model):
