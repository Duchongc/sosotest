...
class TbTaskExecute(models.Model):
    ...
    execBy = models.ForeignKey(to=TbUser, to_field="loginName", related_name="TbTaskExecuteExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名", on_delete=models.CASCADE)
...
class TbInterfaceExecuteHistory(models.Model):
    ...
    taskExecuteId = models.ForeignKey(to=TbTaskExecute,related_name="TbInterfaceExecuteHistoryTaskExecuteId",db_column='taskExecuteId', verbose_name="任务执行表的主键ID，关联哪次执行的任务", on_delete=models.CASCADE)
    ...
    execBy = models.ForeignKey(to=TbUser,to_field="loginName",related_name="TbInterfaceExecuteHistoryExecBy",db_column='execBy', max_length=30, blank=True, default="", verbose_name="执行人登录用户名", on_delete=models.CASCADE)
